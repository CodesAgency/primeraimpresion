...
include('conexion.php');
$registros=mysqli_query($conexion,"select * from acum_nota where codigo='$codigo' and curso='$curso' and ci='$ci' and id_cuestionario='$id_cuestionario'") or
  die("Problemas en el select:".mysqli_error($conexion));
...
header ("Location: online.php?accion=1&pagina=$pagina");
        ...
        mysqli_query($conexion, "update acum_nota
                        ...
                        where codigo='$codigo' and curso='$curso' and ci='$ci' and id_cuestionario='$id_cuestionario'") or
  die("Problemas en el select:".mysqli_error($conexion));
...
$asignatura1 = utf8_decode($_REQUEST[asignatura]);
  ...
  mysqli_query($conexion,"insert into acum_nota(id_cuestionario,respuesta,respuesta_correpta,codigo,curso,ci,punto, n_pregunta, asignatura) values 
                       ('$id_cuestionario','$respuesta','$respuesta_correpta','$codigo','$curso','$ci','$punto', '$_REQUEST[n_pregunta]', '$asignatura1')")
