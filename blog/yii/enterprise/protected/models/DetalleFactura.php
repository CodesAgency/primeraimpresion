...
class DetalleFactura extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('numero_factura, id_producto, cantidad, precio_venta', 'required'),
			array('numero_factura, id_producto, cantidad', 'numerical', 'integerOnly'=>true),
			array('precio_venta', 'numerical'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id_detalle, numero_factura, id_producto, cantidad, precio_venta', 'safe', 'on'=>'search'),
		);
	}
